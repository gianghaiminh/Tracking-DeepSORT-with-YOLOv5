    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if show_vid:
                ...
                fontScale = 1.5
                cv2.putText(im0, text + str(count), org, font, 
...
def count_obj(box,w,h,id):
    ...
    if int(box[1]+(box[3]-box[1])/2) < (h -550):
        if  id not in data:
            count += 1
            data.append(id)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='videos/cars1.mp4', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='inference/output', help='output folder')  # output folder
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[680], help='inference size h,w')
